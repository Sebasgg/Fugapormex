...
public class Estacionamiento3 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estacionamiento3);
...
//------------------------------------------------------------
        ...
        LocationManager locationManager = (LocationManager) Estacionamiento3.this.getSystemService(Context.LOCATION_SERVICE);
