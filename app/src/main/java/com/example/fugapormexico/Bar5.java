    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent o = new Intent( Bar5.this,Bares.class);
                startActivity(o );
        ...
        promociones .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent o = new Intent( Bar5.this,Promociones.class);
                startActivity(o );
            }
        });
        ...
        mDialButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(phoneNo)) {
                    ...
                    Toast.makeText(Bar5.this, "Enter a phone number", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mapa.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent( Bar5.this, MapsActivity1.class );
