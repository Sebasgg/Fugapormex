...
public class Restaurante4 extends AppCompatActivity {
    private Button mapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent o = new Intent( Restaurante4.this,Restaurantes.class);
                startActivity(o );
        ...
        Web1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent o = new Intent( Restaurante4.this,PaginaRes4.class);
                startActivity(o );
            }
        });
        ...
        mDialButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(phoneNo)) {
                    ...
                    Toast.makeText(Restaurante4.this, "Enter a phone number", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
