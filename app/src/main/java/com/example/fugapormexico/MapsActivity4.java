...
public class MapsActivity4 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
//--------------------------------------------------------------
        LatLng sydney = new LatLng(21.87812517400091, -102.3041323748395);
...
//------------------------------------------------------------
        ...
        LocationManager locationManager = (LocationManager) MapsActivity4.this.getSystemService(Context.LOCATION_SERVICE);
